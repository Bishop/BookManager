...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Edition', fields ['isbn']
        db.create_unique('BookManager_edition', ['isbn'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Edition', fields ['isbn']
        db.delete_unique('BookManager_edition', ['isbn'])
